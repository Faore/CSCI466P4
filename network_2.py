...
class Router:
    ...
    def print_routes(self):
        ...
        # Build a 2D array to store the data better.
        destinations = self.rt_tbl_D.keys()
        interfaces = len(self.intf_L)
        rows = self.rt_tbl_D.keys()
        cols = self.intf_L
        ...
        for inf in range(interfaces):
            ...
            print(str(inf) + " ", end="")
            for dest in destinations:
                if inf in self.rt_tbl_D[dest]:
                    print(str(self.rt_tbl_D[dest][inf]) + " ", end="")
                else:
                    print("~ ", end="")
            print()
        print()
